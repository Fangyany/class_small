...
def get_model():
    net0 = Net(config)
    params0 = net0.parameters()
    opt0 = optim.Adam(net0.parameters(), lr=5e-4)


    net1 = Net(config)
    params1 = net1.parameters()
    opt1 = optim.Adam(net1.parameters(), lr=5e-4)

    net2 = Net(config)
    params2 = net2.parameters()
    opt2 = optim.Adam(net2.parameters(), lr=5e-4)

    net3 = Net(config)
    params3 = net3.parameters()
    opt3 = optim.Adam(net3.parameters(), lr=5e-4)
    ...
    return config, ArgoDataset, collate_fn, loss, post_process, net0, opt0, net1, opt1, net2, opt2, net3, opt3
